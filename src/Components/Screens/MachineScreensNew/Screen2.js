    ...
    <div className='mainmain-container' style={{ backgroundImage: 'linear-gradient(to bottom, #3E99ED, #2B7ED6)' }}>
      <div className="main-container">
        ...
        <div className="header">
          <button className="icon-button" onClick={handleBackClick} disabled={processing}>
        ...
        {sensorData.errorFlag === '1' && (
          <div className="error-message" style={{ color: 'yellow', textAlign: 'center', fontWeight: 'bold' }}>
            ⚠️ System Error Detected
          </div>
        )}
        {sensorData.hvacBusy === '1' && !processing && (
          <div className="busy-message" style={{ color: 'orange', textAlign: 'center', fontWeight: 'bold' }}>
