...
import NavScreen from '../DelegateNavbar/DelegateNavbar';
...
const ComplaintForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    customer: customer || (user?.delegate_id || ''),
    created_by: user?.delegate_id || '',
    updated_by: user?.delegate_id || ''
  });
